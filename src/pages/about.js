          ...
          <div className="container">
            ...
            <div className="flex flex-col-reverse gap-8 items-center mb-10 md:flex-row">
              <div className="md:w-2/3">
                ...
                <p>I'm a Freelance Web Developer based in <a href="https://en.wikipedia.org/wiki/Leigh-on-Sea" target="_blank" rel="noreferrer">Leigh-on-Sea</a>, UK. I help Designers and Marketers build Impactful Websites.</p>
