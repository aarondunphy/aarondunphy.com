        ...
        <Layout>
          ...
          <div className="container">
              <div className="py-16">
                ...
                <h1 className="text-3xl font-bold">Freelance Web Developer based in Leigh-on-Sea, UK</h1>
                <h2 className="text-2xl font-bold">I help Designers and Marketers build Impactful Websites</h2>
              </div>
              {/* <div className="mt-16">
                  { posts }
              </div> */}
